          ...
          <Animated.View
            ...
            style={[
              styles.letterCircle,
              {
                ...
                backgroundColor: isSelected ? '#f0c040' : '#d6c9a0',
                borderColor: isSelected ? '#b89020' : '#a89060',
                borderBottomColor: isSelected ? '#8a6000' : '#7a6030',
...
const styles = StyleSheet.create({
  ...
  lineLive: {
    backgroundColor: 'rgba(240,192,64,0.45)',
  },
  letterCircle: {
    position: 'absolute',
