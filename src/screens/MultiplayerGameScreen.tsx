    ...
    <View style={[styles.screen, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <Animated.View
          ...
          <Text style={[styles.wordText, !!wrongWord && styles.wordTextWrong, { fontSize: Math.round(20 * s) }]}>
            {displayWord || ' '}
          </Text>
        </Animated.View>
...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#2d2926' },
  loading: { justifyContent: 'center', alignItems: 'center', gap: 12 },
  loadingText: { color: 'rgba(242,232,208,0.6)', fontSize: 16 },
  header: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  leaveBtnText: { color: '#f2e8d0', fontWeight: '800' },
  wordArea: {
    flex: 1,
    alignItems: 'center',
    paddingVertical: 6,
  ...
  wordText: { color: '#2a1a08', fontWeight: '800', letterSpacing: 4 },
  wordTextWrong: { color: '#fff' },
  scores: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 6,
  ...
  scoreName: { color: '#7a5a30', fontWeight: '700' },
  scoreNum: { color: '#2e8040', fontWeight: '900' },
  scoreDivider: { color: '#c4a870', fontWeight: '700' },
  ...
  progressDotFound: { backgroundColor: '#f0c040', borderColor: '#c49020' },
  modeLabel: {
    position: 'absolute',
    left: 14,
  ...
  flyLetterText: { color: '#2a1a08', fontWeight: '800' },
  overlay: {
    flex: 1,
  ...
  overlayTitle: { fontSize: 22, fontWeight: '900', color: '#2a1a08', letterSpacing: 1 },
  overlayScore: { fontSize: 34, fontWeight: '900', color: '#2e8040', letterSpacing: 4 },
  overlayHint: { fontSize: 13, color: '#7a5a30', marginTop: 4, fontWeight: '500' },
  overlayBtn: {
  ...
  overlayBtnText: { color: '#fff', fontSize: 15, fontWeight: '800', letterSpacing: 0.5 },
  overlayCancelBtn: {
    paddingVertical: 10,
  ...
  overlayCancelText: { color: '#fff', fontSize: 14, fontWeight: '700' },
});
